...
from timm.models.layers.cross_bottleneck_attn import CrossBottleneckAttn
...
class TokenInitializer(nn.Module):
    ...
    def __init__(self,
        ...
        """
        super().__init__()
        # print(input_resolution, window_size, ct_size)
    ...
    def forward(self, x):
        ...
        B, C, H, W = x.shape
        # print(B, C, H, W, self.window_size)
...
class FasterViTCrossAttn(FasterViT):
    def __init__(self,
                 dim,
                 in_dim,
                 depths,
        ...
        super().__init__(dim,
                 ...
                 do_propagation,
                 **kwargs)
        self.map = CrossBottleneckAttn(self.num_features, 
                                           dim_out=self.num_features, 
                                           num_heads=1, 
                                           feat_size=(7, 7))
...
@register_model
def faster_vit_0_224_crossattn(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [2, 3, 6, 5])
    num_heads = kwargs.pop("num_heads", [2, 4, 8, 16])
    window_size = kwargs.pop("window_size", [7, 7, 7, 7])
    ct_size = kwargs.pop("ct_size", 2)
    ...
    model_path = kwargs.pop("model_path", "/tmp/faster_vit_0.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    model = FasterViTCrossAttn(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
                      ct_size=ct_size,
                      dim=dim,
...
@register_model
def faster_vit_0_224_crossattn_lowres(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [2, 3, 6])
    num_heads = kwargs.pop("num_heads", [2, 4, 8])
    window_size = kwargs.pop("window_size", [7, 7, 7])
    ct_size = kwargs.pop("ct_size", 2)
    dim = kwargs.pop("dim", 64)
    in_dim = kwargs.pop("in_dim", 64)
    mlp_ratio = kwargs.pop("mlp_ratio", 4)
    resolution = kwargs.pop("resolution", 112)
    drop_path_rate = kwargs.pop("drop_path_rate", 0.2)
    model_path = kwargs.pop("model_path", "/tmp/faster_vit_0.pth.tar")
    hat = kwargs.pop("hat", [False, False, True])
    model = FasterViTCrossAttn(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
                      ct_size=ct_size,
...
@register_model
def faster_vit_0_224_cat(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [2, 3, 6, 5])
    num_heads = kwargs.pop("num_heads", [2, 4, 8, 16])
    window_size = kwargs.pop("window_size", [7, 7, 7, 7])
    ct_size = kwargs.pop("ct_size", 2)
    ...
    model_path = kwargs.pop("model_path", "/tmp/faster_vit_0.pth.tar")
    hat = kwargs.pop("hat", [False, False, True, False])
    model = FasterViTCat(depths=depths,
                      num_heads=num_heads,
                      window_size=window_size,
                      ct_size=ct_size,
                      dim=dim,
...
@register_model
def faster_vit_1_224_crossattn(pretrained=False, **kwargs):
    depths = kwargs.pop("depths", [1, 3, 8, 5])
    num_heads = kwargs.pop("num_heads", [2, 4, 8, 16])
    window_size = kwargs.pop("window_size", [7, 7, 7, 7])
    ct_size = kwargs.pop("ct_size", 2)
